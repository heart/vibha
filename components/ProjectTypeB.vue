...
import FirstFloor from "../components/TypeB/FirstFloor.vue";
import SecondFloor from "../components/TypeB/SecondFloor.vue";
import SecondMFloor from "../components/TypeB/SecondMFloor.vue";
import ThirdFloor from "../components/TypeB/ThirdFloor.vue";
import Rooftop from "../components/TypeB/Rooftop.vue";
